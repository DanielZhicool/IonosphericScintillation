        ...
        try:
            ...
            for session in self.selected_sessions:
                ...
                if needs_spectral:
                    ...
                    self.progress.emit(
                        int((tasks_done / max(1, total_tasks)) * 100),
                        ...
                        if self.graphs_config.get("cross", False):
                            ...
                            for pol_name, r in pols:
                                if pol_name in cross_data:
                                    ...
                                    if r == 0:
                                        ax_re.set_title("Co-spectrum (In-phase)")
                ...
                for channel in self.selected_channels:
                    ...
                    for band_key, cwt_low, cwt_high in self.bands:
                        ...
                        if needs_filtered:
                            time_plots.append("filtered")
                        if needs_spec:
                            time_plots.append("spectrogram")
