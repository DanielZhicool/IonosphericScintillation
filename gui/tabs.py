...
from gui.constants import IONOSPHERIC_TITLE, MAIN_TAB_NAME, RAW_DATA_TITLE_TEMPLATE, SPECTROGRAM_TITLE
...
class SignalTab(QWidget):
    ...
    def set_channel(self, channel_name, force=False):
        if (
            ...
            and self.curve_filtered.xData is not None
            and len(self.curve_filtered.xData) > 0
        ):
            return
